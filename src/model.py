...
class MyModel(nn.Module):
    def __init__(self, num_classes: int = 1000, dropout: float = 0.7) -> None:
        ...
        self.model = nn.Sequential(
            ...
            nn.Conv2d(16, 32, 3, padding=1),  # -> 112x112x32
            # Add batch normalization (BatchNorm2d) here
            nn.BatchNorm2d(32),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),  # -> 56x56x32
            
            nn.Conv2d(32, 64, 3, padding=1),  # -> 56x56x32
            # Add batch normalization (BatchNorm2d) here
            nn.BatchNorm2d(64),
            nn.ReLU(),
            ...
            nn.Conv2d(64, 128, 3, padding=1),  # -> 28x28x64
            # Add batch normalization (BatchNorm2d) here
            # YOUR CODE HERE
            nn.BatchNorm2d(128),
            nn.ReLU(),
            ...
            nn.Conv2d(128, 256, 3, padding=1),  # -> 14x14x128
            # Add batch normalization (BatchNorm2d) here
            # YOUR CODE HERE
            nn.BatchNorm2d(256),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),  # -> 7x7x12
